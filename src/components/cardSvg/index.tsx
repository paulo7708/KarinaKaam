        ...
        <ContainerCard>
          <Card>
            <NavLink to='/faleconosco'>
              <img loading="lazy" className='img1' src={PortResidencial[4].img} />
              <h1>Projeto 3D</h1>
          ...
          <Card>
            <NavLink to='/faleconosco'>
              <img loading="lazy" className='img2' src={PortResidencial[6].img} />
          ...
          <Card>
            <NavLink to='/faleconosco'>
              <img loading="lazy" className='img3' src={PortResidencial[3].img} />
              <h1>Orçamento</h1>
          ...
          <Card>
            <NavLink to='/faleconosco'>
              <img loading="lazy" className='img4' src={PortResidencial[7].img} />
